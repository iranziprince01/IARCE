                      ...
                      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                          <td width="120" style="vertical-align: top;">
                            <strong style="color: #1e40af; font-size: 14px; display: block; margin-bottom: 4px;">Name:</strong>
                          </td>
                          <td style="vertical-align: top;">
                            <span style="color: #374151; font-size: 15px; font-weight: 600;">${sanitizedName}</span>
                          </td>
                        </tr>
                      </table>
                    </td>
                  ...
                  <tr>
                    <td style="padding: 12px 0;">
                      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                          <td width="120" style="vertical-align: top;">
                            <strong style="color: #1e40af; font-size: 14px; display: block; margin-bottom: 4px;">Phone:</strong>
                          </td>
                          <td style="vertical-align: top;">
                            <a href="tel:${sanitizedPhone}" style="color: #2563eb; font-size: 15px; font-weight: 600; text-decoration: none; border-bottom: 1px solid #2563eb; padding-bottom: 2px;">${sanitizedPhone}</a>
                          </td>
                        </tr>
                      </table>
                    </td>
            ...
            <td style="padding: 0 30px 30px 30px;">
              <div style="background-color: #ffffff; border-radius: 10px; padding: 25px; border: 2px solid #f8b518; box-shadow: 0 2px 8px rgba(248, 181, 24, 0.15);">
                ...
                <div style="background-color: #f9fafb; padding: 20px; border-radius: 8px; border-left: 4px solid #f8b518; margin-top: 15px;">
                  <p style="margin: 0; color: #374151; font-size: 15px; line-height: 1.8; white-space: pre-wrap; font-family: 'Georgia', serif;">${sanitizedMessage}</p>
                </div>
              </div>
            </td>
          </tr>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center">
                <tr>
                  <td style="background: linear-gradient(135deg, #2563eb 0%, #1e40af 100%); border-radius: 8px; padding: 0;">
                    <a href="mailto:${sanitizedEmail}?subject=Re: Your Contact Form Message&body=Dear ${sanitizedName},%0D%0A%0D%0AThank you for contacting International Anglican Revival Ministries..." style="display: inline-block; padding: 14px 32px; color: #ffffff; text-decoration: none; font-weight: 600; font-size: 15px; border-radius: 8px; box-shadow: 0 4px 6px rgba(37, 99, 235, 0.3);">
          ...
          <tr>
            <td style="background-color: #f9fafb; padding: 25px 30px; border-top: 1px solid #e5e7eb; text-align: center;">
              <p style="margin: 0 0 10px 0; color: #6b7280; font-size: 13px; line-height: 1.6;">
                This message was sent from the <strong style="color: #1e40af;">International Anglican Revival Ministries</strong> contact form.
              </p>
